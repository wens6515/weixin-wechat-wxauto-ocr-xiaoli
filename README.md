...
> **v2.7.0「按聊天绑定角色卡」** · 适配微信 PC **4.x** · 每个聊天可绑不同人设/模型（记忆页一键绑定）· 首页更新检查 · PDF 直读

---

## ⬇️ 下载安装（桌面版）

**v2.7.0 完整桌面版安装包**（PySide6 图形界面 + 19 套主题 + 壁纸库 + 托盘常驻）：

👉 [点击下载 `xiaoli-setup-v2.7.0.exe`](https://github.com/wens6515/weixin-wechat-wxauto-ocr-xiaoli/releases/download/v2.7.0/xiaoli-setup-v2.7.0.exe)
